...
const files = Object.freeze({
  ...
  dockerFile: (new URL('../../../../../configs/nodejs/docker/build-image.Dockerfile', import.meta.url)).pathname,
});
...
export const buildService = async (context) => {
  ...
  // docker build --build-arg node_version=15.10.0 --build-arg package_name=node_v15.10.0 --build-arg image_name=kaufmann-web --tag kaufmann-web --file ./build-image.Dockerfile .
